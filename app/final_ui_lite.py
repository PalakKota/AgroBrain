...
T = {
    # Backgrounds — light sandstone / warm parchment
    "bg_deep":       "#f4e7dc",
    "bg_card":       "#fffaf5",
    "bg_card2":      "#f9efe6",
    "bg_card3":      "#f3e4d8",
    "border":        "#e0c6b3",
    "border_bright": "#d7a98a",

    # Accent family — terracotta / warm orange
    "accent":        "#e86a33",   # primary terracotta
    "accent2":       "#f29a5a",   # warm orange
    "accent3":       "#f6c177",   # soft golden amber
    "accent_red":    "#e14b4b",   # error
    "accent_blue":   "#4fa3d1",   # info
    "accent_green":  "#5aa469",   # success
    ...
    # Glow & gradients
    "glow_rgba":     "rgba(232,106,51,0.12)",
    "glow_rgba2":    "rgba(242,154,90,0.08)",
    "hero_grad":     "linear-gradient(135deg, #fffaf5 0%, #f3e4d8 50%, #f8efe7 100%)",

    # Plotly
    "bar_grad":      [[0, "#e8d2c3"], [0.5, "#f29a5a"], [1.0, "#e86a33"]],
    "gantt_fill":    "rgba(232,106,51,0.18)",
    "gantt_line":    "#e86a33",
    "plot_grid":     "#e4d0c3",
    "plot_text":     "#7a5a46",
    "plot_title":    "#3a2417",
    ...
    # Gauge step colours
    "gauge_poor":    "rgba(225,75,75,0.18)",
    "gauge_fair":    "rgba(79,163,209,0.15)",
    "gauge_good":    "rgba(246,193,119,0.15)",
    "gauge_great":   "rgba(232,106,51,0.18)",
